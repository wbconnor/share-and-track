...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post achievements_url, params: { achievement: { activity_id: @achievement.activity_id, quantity: @achievement.quantity, session_id: @achievement.session_id, time: @achievement.time, weight: @achievement.weight } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { activity_id: @achievement.activity_id, quantity: @achievement.quantity, session_id: @achievement.session_id, time: @achievement.time, weight: @achievement.weight } }
